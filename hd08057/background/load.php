...
<head>
	...
	<style type="text/css">
		...
		input{background:#E3E3E3;color:#000;}
		button{margin-top:10px;width:100px;}
		.btn-danger{color:#E3E3E3;}
	</style>
</head>
<body>
	<div class="box" style="width:460px;position:absolute;top:50%;left:50%; margin-left:-230px;margin-top:-95px;border:1px solid #E3E3E3;">
		<p style="background:#303030;height:30px;line-height:30px;color:#E3E3E3;text-align:center;font-size:20px;">后台登陆</p>
