...
<body>
	<?php
 $conn = new mysqli("localhost","asd","asdasd","my_item"); $conn->query('set names utf8'); if($conn->connect_error){ die("OK"); } ?>
	<div class="container">
		<div class="row">
	        <div class="col-md-9 col-lg-9 divRight">
				<table class="table table-condensed ">
					...
					<tbody>
                        <?php  $sql = "SELECT * FROM avia_title"; $result = $conn->query($sql); if($result->num_rows>0){ while($row = $result->fetch_assoc()){ ?>	
						<tr>
