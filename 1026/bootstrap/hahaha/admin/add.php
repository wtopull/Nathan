    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9" style="border-left:1px solid #eaeaea; margin-bottom:50px; ">
                <form method="post" action="php/doadd.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="ac_title">文章标题</label>
                        <input type="text" class="form-control" id="ac_title" name="ac_title" placeholder="文章标题">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="ac_desc" name="ac_desc" rows="3"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="ac_keyword">关键字</label>
                        <input type="text" class="form-control" id="ac_keyword" name="ac_keyword" placeholder="关键字">
                    </div>
                    <div class="form-group">
