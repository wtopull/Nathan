<?php
    ...
    $sql="select * from article where ac_title like '%$search%';";
    $pageSql="select * from article where ac_title like '%$search%' limit $start,$pageSize;";
...
<div class="container">
    ...
    <div class="page-header">
        <h2 style="font-family: '宋体'">搜索内容: <?php echo $search;?></h2>
    </div>
    <!--------------content------------->
...
?>
    ...
    <div style="text-align:center">
        <nav aria-label="Page navigation">
            <ul class="pagination">
                <li>
                    <a href="showlist.php?search=<?php echo $search; ?>&pageId=<?php if($pageId<=1){ echo 1;}else{ echo $pageId-1;}?>" aria-label="Previous">
...
<?php
    ...
    for($i=1;$i<=$pages;$i++){
?>
        <li class="<?php if($i==$pageId){ echo 'active';}?>"><a href="showlist.php?pageId=<?php echo $i;?>"><?php echo $i; ?></a></li>
<?php
    }
?>
                <li>
                    <a href="showlist.php?search=<?php echo $search; ?>&pageId=<?php if($pageId>=$pages){ echo $pages;}else{ echo $pageId+1;}?>" aria-label="Next">
